...
export default class GlobalPostgreModel extends GlobalSqlModel {
    ...
    select: (tableName: string, distinct: boolean, attributes: AttrAndAlias[], wheres: (WhereAttribute | WhereKeyWord)[], sorts: SortAttribute[], tableAlias: string, limit: number, offset?: number) => Promise<QueryResult<any> | null>;
