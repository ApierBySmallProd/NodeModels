...
class GlobalMicrosoftModel extends global_sql_1.default {
    constructor() {
        ...
        this.select = (tableName, distinct, attributes, wheres, sorts, tableAlias, limit, offset = 0, joins, groups, havings) => __awaiter(this, void 0, void 0, function* () {
            const query = `SELECT${distinct ? ' DISTINCT' : ''}${this.computeAttributes(attributes)} FROM \`${tableName}\` AS ${tableAlias} ${this.computeJoins(joins)}${this.computeWhere(wheres, '@', true)}${this.computeGroupBy(groups)}${this.computeWhere(havings, '?', false, 'HAVING')}${this.computeSort(sorts)}${limit !== -1
