...
export default class GlobalOracleModel extends GlobalSqlModel {
    ...
    select: (tableName: string, distinct: boolean, attributes: AttrAndAlias[], wheres: (WhereAttribute | WhereKeyWord)[], sorts: SortAttribute[], limit: number, offset?: number) => Promise<oracle.Result<unknown> | null>;
