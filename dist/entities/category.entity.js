...
let CategoryEntity = class CategoryEntity extends entity_1.default {
    constructor(label) {
        super();
        this.id = 0;
        this.articles = [];
        this.fetchArticles = () => __awaiter(this, void 0, void 0, function* () {
            return yield this.fetch('articles');
        });
        this.label = label;
    }
};
...
__decorate([
    ...
    property_1.Unique()
], CategoryEntity.prototype, "label", void 0);
__decorate([
    property_1.OneToMany('article')
], CategoryEntity.prototype, "articles", void 0);
CategoryEntity = __decorate([
    other_1.Table('category'),
    other_1.AutoCreateNUpdate()
], CategoryEntity);
exports.default = CategoryEntity;
entitymanager_1.default.registerEntity(CategoryEntity);
